...
- Preview: https://main--edgecommercedemo--MarcLudwigCareer.hlx.page/
- Live: https://main--edgecommercedemo--MarcLudwigCareer.hlx.live/
...
1. Open the `edgecommercedemo` directory in your favorite IDE and start coding :)
